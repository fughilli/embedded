/* Reset vector + interrupt vector table for the STM32G0 family (Arm Cortex-M0+).
 *
 ...
 * (.data copy, .bss zero, C++ ctors) and calls main(). The IRQ layout follows
 * the STM32G0B1/G0C1 (category 5, RM0444) table — the family superset: it is a
 * valid vector table for the smaller G0 parts too (their unused slots simply
 * stay Default_Handler). Every IRQ defaults to a spin loop unless a strong
 * definition overrides the weak alias.
 *
 * Symbols (_sidata, _sdata, _edata, _sbss, _ebss, _estack) come from the
 * generated stm32g0 linker script (see //libs/board/stm32g0:stm32g0.bzl).
 */
#include <stdint.h>
...
/* Core system exceptions + STM32G0B1/G0C1 peripheral IRQs (RM0444, category 5).
 * Each is a weak alias of Default_Handler; define a strong symbol of the same
 * name to hook it. */
...
void (*const g_pfnVectors[])(void) = {
    ...
    USB_UCPD1_2_IRQHandler,                      /* 8 */
    DMA1_Channel1_IRQHandler,                    /* 9 */
    DMA1_Channel2_3_IRQHandler,                  /* 10 */
    DMA1_Ch4_7_DMA2_Ch1_5_DMAMUX1_OVR_IRQHandler, /* 11 */
    ADC1_COMP_IRQHandler,                        /* 12 */
    TIM1_BRK_UP_TRG_COM_IRQHandler,              /* 13 */
    TIM1_CC_IRQHandler,                          /* 14 */
    TIM2_IRQHandler,                             /* 15 */
    TIM3_TIM4_IRQHandler,                        /* 16 */
    TIM6_DAC_LPTIM1_IRQHandler,                  /* 17 */
    TIM7_LPTIM2_IRQHandler,                      /* 18 */
    TIM14_IRQHandler,                            /* 19 */
    TIM15_IRQHandler,                            /* 20 */
    TIM16_FDCAN_IT0_IRQHandler,                  /* 21 */
    TIM17_FDCAN_IT1_IRQHandler,                  /* 22 */
    I2C1_IRQHandler,                             /* 23 */
    I2C2_I2C3_IRQHandler,                        /* 24 */
    SPI1_IRQHandler,                             /* 25 */
    SPI2_SPI3_IRQHandler,                        /* 26 */
    USART1_IRQHandler,                           /* 27 */
    USART2_LPUART2_IRQHandler,                   /* 28 */
    USART3_4_5_6_LPUART1_IRQHandler,             /* 29 */
    CEC_IRQHandler,                              /* 30 */
